...
export function runScalene() {
  ...
  let command = `scalene --json --no-browser --cli --outfile ${workspaceDirectory}/profile.json ${workspaceDirectory}/main.py`; // --cli will output to stdout so I don't have to use a file
